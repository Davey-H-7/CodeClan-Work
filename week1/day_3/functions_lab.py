...
print("By multiplying 4 and 5, I'm expecting it to be 20, and the result is")
...
print("------------------------------")
# replace _ with your own values and expectation:
print("By dividing 30 by 6, I'm expecting it to be 5, and the result is")
...
def number_to_full_name2(month):
