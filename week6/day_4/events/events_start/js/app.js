document.addEventListener('DOMContentLoaded', () => {
  ...
  const handleButtonClick = function(){
    ...
    resultParagraph.textContent = 'That Button was heavy clicked'
  }
  ...
  const handleFormSubmit = function (event){  event.preventDefault();
    const resultParagraph = document.querySelector('#form-result')
    resultParagraph.textContent = `
    Your name: ${event.target.first_name.value} ${event.target.last_name.value}`
  }
